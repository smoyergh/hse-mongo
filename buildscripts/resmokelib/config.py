...
# Default prefix for mpools generated by resmoke.py.
DEFAULT_HSE_MPOOL_NAME_PREFIX = "resmoke"
...
DEFAULTS = {
    ...
    "hseParams": None,
    "hseMpoolNamePrefix": None,
    "hseCollComprAlgo": None,
    "hseCollComprMinSz": None,
